...
export default function AddNewMechanic() {
  ...
  const handleAddMechanic = async () => {
    ...
    formData.append("email", mechanicEmail);
        ...
        <div className="row justify-content-center">
          <div className="col-md-7 pe-md-4">
            <div
              ...
              style={{ height: "100%" }}
            >
              <h5 className="text-center colorOrange py-3">Add New Mechanic</h5>
              <div className="text-center">
                <div className="position-relative d-inline-flex align-items-center justify-content-center rounded-circle">
                  <input
                    type="file"
                    accept="image/*"
                    onChange={(e) => {
                      ...
                      <div className="position-relative w-100">
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            if (file) {
                              const reader = new FileReader();
                              reader.onload = (e) =>
                                setCertificationPreview(e.target.result);
                              reader.readAsDataURL(file);
                            }
                          }}
                          style={{ display: "none" }}
                        ...
                        <div
                          ...
                          style={{
                            color: "#E25C28",
                            cursor: "pointer",
                            backgroundImage: certificationPreview
                              ? `url(${certificationPreview})`
                              : "none",
                          ...
                          >
                            {!certificationPreview && (
                              <div className="d-flex ">
                                ...
                                />
                                <p className="mt-2">
                                  Click to upload Mechanic Certification
                                </p>
                              </div>
                            )}
                          </label>
